...
<div class="wrap">
  ...
  <div class="tabmenu">
    <ul class="tab pngFix">
  <li class="active"><a href="#">用户信息修改</a></li></ul>
  </div>
  				<!-- userInfo.jsp -->																<!--  enctype="multipart/form-data" -->
  	 <form action="<c:url value="UserUpdateServlet"/>"  method="post" id="myform" name="myform" >
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                        </tr>
                            <tr>
                                <th>用户名：</th><!-- 用户名 -->
                               <td><input type="text" value="${loginUser.usLoginName }" readonly/></td> 
                            </tr>
							<tr>
                                <th>昵&nbsp;&nbsp;&nbsp;&nbsp;称：</th>
                                <td><input type="text" name="newNike"/></td> 
                            ...
                            <tr>
                                ...
                                <td style="float:right;border:none;margin-right:-140px;">
                                   ...
                                   <a href="<c:url value="UserUpdateServlet"/>" />
                                   	<input class="btn btn-primary btn6 mr10" type="submit" value="确定修改"/>
                                   </a>
