...
<script type="text/javascript">
	uaredirect("/wap/index.php?act=member_address&op=address");
</script>
...
<body>
			...
			<div class="ever">
				<div class="cart">
					<a href="javascript:void(0);" id="rtoolbar_cart"><span
						class="icon"></span> <span class="name">购物车</span><i
				...
				<div class="middle">
					...
					<div class="user-info" nctype="barUserInfo" style="display:none;">
						...
						<dl>
							...
							<dd>
								当前等级：<strong nctype="barMemberGrade">V0</strong>
							</dd>
							<dd>
								当前经验值：<strong nctype="barMemberExp">30</strong>
							</dd>
						</dl>
					</div>
	...
	<div class="public-top-layout w">
		<div class="topbar wrapper">
			<div class="user-entry">
				...
				<c:if test="${loginUser != null }">
					<div class="topOne1_left">
						你好<a href="userInfo.jsp">${ loginUser. usLoginName}</a>,欢迎来到<i><a
			...
			<div class="quick-menu">
				...
				<dl>
					<dt>
						<a href="http://huashi.hqskjy.com/order-search.jsp"
							target="_blank"><label
				...
				<dl>
					<dt>
						<a href="http://huashi.hqskjy.com/suggestion.jsp" target="_blank">投诉建议</a>
					</dt>
				</dl>
				<dl>
					<dt>
						<a href="http://huashi.hqskjy.com/shop/index.php?act=member_order">我的订单</a><i></i>
					</dt>
					<dd>
						<ul>
							<li><a
								href="http://huashi.hqskjy.com/shop/index.php?act=member_order&amp;state_type=state_new">待付款订单</a></li>
							<li><a
								href="http://huashi.hqskjy.com/shop/index.php?act=member_order&amp;state_type=state_send">待确认收货</a></li>
							<li><a
								href="http://huashi.hqskjy.com/shop/index.php?act=member_order&amp;state_type=state_noeval">待评价交易</a></li>
						</ul>
					</dd>
				</dl>
				<dl>
					<dt>
						<a
							href="http://huashi.hqskjy.com/shop/index.php?act=member_favorites&amp;op=fglist">我的收藏</a><i></i>
					</dt>
					<dd>
						<ul>
							<li><a
								href="http://huashi.hqskjy.com/shop/index.php?act=member_favorites&amp;op=fglist">商品收藏</a></li>
						</ul>
					</dd>
				</dl>
				<dl>
	...
	<div class="header-wrap">
		<header class="public-head-layout wrapper">
			...
			<div id="search" class="head-search-bar" style="margin-left:90px;">
				...
				<div class="keyword">
					热门搜索：
					<ul>
						<li><a href="http://huashi.hqskjy.com/list-1067.jsp">情人节</a></li>
						<li><a href="http://huashi.hqskjy.com/list-151.jsp">玫瑰</a></li>
						<li><a href="http://huashi.hqskjy.com/list-152.jsp">百合</a></li>
						<li><a href="http://huashi.hqskjy.com/list-151_1098.jsp">蓝色妖姬</a></li>
						<li><a href="http://huashi.hqskjy.com/list-259.jsp">爱情</a></li>
						<li><a href="http://huashi.hqskjy.com/list-1102.jsp">花篮</a></li>
						<li><a href="http://huashi.hqskjy.com/list-1113.jsp">教师</a></li>
						<li><a href="http://huashi.hqskjy.com/list-1066.jsp">七夕</a></li>
					</ul>
				</div>
			</div>
        ...
        -->
					...
					<dd>
						...
						<div class="checkout">
							<span class="total-price">共<i>${totalnum }</i>种商品
							</span><a href="busOrder.jsp" class="btn-cart">结算购物车中的商品</a>
						</div>
					</dd>
				</dl>
			</div>
	...
	<div class="nch-breadcrumb-layout">
		<div class="nch-breadcrumb wrapper">
			<i class="icon-home"></i> <span><a href="<c:url value="FindAllTypeServlet"/>">首页</a></span><span
				class="arrow">&gt;</span> <span><a href="#">个人中心</a></span><span
				class="arrow">&gt;</span> <span>订单列表</span>
		</div>
	</div>
	...
	<div id="toolTipLayer"
		style="position: absolute; z-index: 999; display: none; visibility: visible; left: 1096px; top: 447px;"></div>
	<script>
		//sidebar-menu
		$(document).ready(
				function() {
	...
	<div class="ncm-container">
			...
			<div class="ncm-user-info">
				...
				<div class="handle">
					<a href="userLogo.jsp" title="修改头像"><i class="icon-camera"></i>修改头像</a><a
						href="userInfoUpdate.jsp" title="修改资料"><i class="icon-pencil"></i>修改资料</a><a
						href="userPwd.jsp" title="修改密码"><i class="icon-off"></i>修改密码</a>
				</div>
				<div class="name">
					${loginUser. usLoginName}&nbsp;
		...
		<div class="right-layout">
			...
			<div class="wrap">
				...
				<div class="tabmenu">
					<ul class="tab pngFix">
						...
						<li class="normal"><a href="#">回收站</a></li>
					</ul>
				</div>
				...
				<table class="ncm-default-table order">
					<thead>
						<tr>
							...
							<th class="w120">收货人</th>
							<th class="w100">地址</th>
							<th class="w100">联系电话</th>
							<th class="w150">订单总价</th>
							<th class="w100">操作</th>
						</tr>
					</thead>
					<tbody order_id="">
						...
						<c:forEach items="${orederList }" var="orders">
							<tr>
								<th class="w10"></th>
								<th colspan="2">${orders.ordNo }</th>
								<th class="w120">&nbsp;&nbsp;${orders.ordData }</th>
								<th class="w150">&nbsp;&nbsp;${loginUser.usLoginName }</th>
								<th class="w120">&nbsp;&nbsp;${orders.ordName }</th>
								<th class="w100">&nbsp;&nbsp;${orders.address }</th>
								<th class="w150">&nbsp;&nbsp;${orders.phone }</th>
								<th class="w100">&nbsp;&nbsp;${orders.ordPrice }</th>
								<th class="w100"><a
									href="<c:url value="SelectByOrdersNo?ordNo=${orders.ordNo }"/>">&nbsp;&nbsp;订单详情</a></th>
							</tr>
						</c:forEach>
					</tbody>
					<tbody order_id="">
			...
			<script charset="utf-8" type="text/javascript"
				src="./order_files/zh-CN.js"></script>
			<script charset="utf-8" type="text/javascript"
				src="./order_files/sns.js"></script>
			<script type="text/javascript">
				$(function() {
	...
	<div id="faq">
		...
		<div id="footer" class="wrapper">
			...
			Copyright 2017 Copyright© 2005-2017 中网慧谷网络科技（北京）有限公司 版权所有，并保留所有权利。
...
.set_chat .chat_sh {
	...
	text-align: center;
		...
		<div
							style="width:480px; height:200px; background-color:#fff; display:none; position:absolute;top:328px; left:500px; border:solid 1px #888; "
							id="showadd">
