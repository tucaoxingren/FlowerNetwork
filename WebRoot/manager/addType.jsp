...
function fun(){
	alert(document.getElementByName('type_name').value);
}
</script>
<script type="text/javascript">
		...
		<div class="xia">
			...
			<div class="sidebar-right">
				<div id="content" style="background-color:#FFF;">
					<div id="yi">
						<div id="yi-1">&nbsp;添加商品类型</div>
					</div>
					<div id="er">
					<!-- <c:url value="/AddTypeServlet"/> -->
					<!-- enctype="multipart/form-data" -->
						<form action="<c:url value="/AddTypeServlet"/>" method="post"
							class="definewidth m20" >
							<table width="1110" class="table table-bordered table-hover m10">
								
								<tr class="trs">
									<td width="128" class="tableleft">类型名称</td>
									<td><input type="text" name="type_name" id="type_name" /> <!-- good_name --></td>
								</tr>

								<tr class="trs">
									<td width="128" class="tableleft">类型备注</td>
									<td><input type="text" name="type_remark" id="type_remark" /></td>
								</tr>
									...
									<td>
										...
										<p class="p">
											...
											<a href="#"> <input 
												...
												value="添加">
											</a> <a href="<c:url value="/FindAllServlet"/>"><input
