 ...
 * 
 */
public class UpdateFlowerUpload extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			...
			if (formItems != null && formItems.size() > 0) {
				...
				for (FileItem item : formItems) {
					...
					if (!item.isFormField()) {
					    ...
					    //Files.copy(dest.toPath(),source.toPath());
		...
		//String str = request.getParameter("good_action");
		//System.out.println(str);
		// 跳转到 message.jsp
		...
		getServletContext().getRequestDispatcher("/UpdateFlowerPre").forward(
				request, response);
